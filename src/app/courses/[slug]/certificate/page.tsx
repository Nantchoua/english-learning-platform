  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col print:bg-white print:p-0">
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-6 py-12 flex flex-col items-center justify-center space-y-6">
        ...
        {/* Print & Share Buttons Container */}
        <div className="flex flex-col sm:flex-row items-center gap-4 print:hidden">
          <PrintButton />
          
          <a
            href={`https://www.linkedin.com/sharing/share-offsite/?url=https://www.speakingexpressenglish.com/courses/${slug}`}
            target="_blank"
            rel="noopener noreferrer"
            className="bg-[#0077b5] hover:bg-[#005c8c] text-white font-semibold py-2.5 px-6 rounded-lg text-sm transition flex items-center gap-2 shadow cursor-pointer"
          >
